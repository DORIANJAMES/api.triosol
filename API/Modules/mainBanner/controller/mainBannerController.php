<?php
class mainBannerController extends mainController
{
    protected static $CrudPDO;
    protected static $mainBannerModel;
    protected static $returnArray;

    public function __construct($returnArray) {
        self::$mainBannerModel = new mainBannerModel();
    ...
    public static function update() {
        if(isset($_POST)) {
            ...
            $update = self::$mainBannerModel::update($tableName, $postArray);
